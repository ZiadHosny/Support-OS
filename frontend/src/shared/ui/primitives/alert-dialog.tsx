...
// logical ones. `shadcn diff alert-dialog` will always report this file as
// changed. See CONVENTIONS.md §19 before re-running `shadcn add alert-dialog`.
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        data-size={size}
        className={cn(
          // `left-[50%]` + `translate-x-[-50%]` is symmetric, so it stays
          // physical on purpose — see the same note in primitives/dialog.tsx
          // and CONVENTIONS.md §19.
          // See the same max-h/overflow-y-auto note in primitives/dialog.tsx.

...
// logical ones, and the two "Close" literals routed through i18next.
// `shadcn diff dialog` will always report this file as changed. See
// CONVENTIONS.md §19 before re-running `shadcn add dialog`.

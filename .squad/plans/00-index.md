...
| node-js-backend-port | [node-js-backend-port/00-overview.md](node-js-backend-port/00-overview.md) | 116–119 (EPIC 18, NODE-0 through NODE-12; NODE-0 (Story 116, SUPPORTOS-141), NODE-1 (Story 117, SUPPORTOS-142) and NODE-2 (Story 118, SUPPORTOS-143) are planned **and implemented**, NODE-3 (Story 119, SUPPORTOS-144) is planned. The remaining 9 stories are listed in the overview but not yet planned. The port replaces the Django API behind an unchanged contract and adds **no product scope**) |

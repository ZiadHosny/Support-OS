...
export const envSchema = z.object({
  // --- Database (composed into a URL for Prisma; see database-url.ts) ---
  ...
  // `base.py:196` falls back to SECRET_KEY when blank, which is the normal
  // state in this project's .env — the fallback is the live path.
